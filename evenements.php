...
<head>
    ...
    <title>Organisation d'Événements - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Evenement.jpg" alt="Organisation d'Événements" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Evenement.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services d'Organisation d'Événements</h3>
                    <i class="fas fa-calendar-alt fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-wedding-ring text-danger"></i> Organisation de Mariages (Prix: 500 - 5000 €)</li>
                <li><i class="fas fa-birthday-cake text-primary"></i> Anniversaires (Prix: 200 - 2000 €)</li>
                <li><i class="fas fa-concierge-bell text-success"></i> Événements d'Entreprise (Prix: 300 - 3000 €)</li>
                <li><i class="fas fa-meeting text-info"></i> Séminaires et Conférences (Prix: 400 - 4000 €)</li>
                <li><i class="fas fa-festival text-info"></i> Fêtes et Festivals (Prix: 600 - 6000 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Organisatiion d'evenements"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="mariages">Organisation de Mariages</option>
                        <option value="anniversaires">Anniversaires</option>
                        <option value="evenements_entreprise">Événements d'Entreprise</option>
                        <option value="seminaires">Séminaires et Conférences</option>
                        <option value="fetivals">Fêtes et Festivals</option>
                ...
                <div class="form-group" id="date-request" style="display: none;">
                    <label for="request-date">Date de l'Événement :</label>
                ...
                <div class="form-group">
                    <label for="user-address">Adresse de l'Événement(ville et code postal) :</label>
