...
<head>
    ...
    <title>Réparation de Vélos - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Velo.jpg" alt="Réparation de Vélos" class="img-fluid rounded" style="width: 69%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Velos.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Réparation de Vélos</h3>
                    <i class="fas fa-bicycle fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-tools text-danger"></i> Réparation de Pannes (Prix: 30 - 150 €)</li>
                <li><i class="fas fa-cogs text-primary"></i> Réglage de Freins (Prix: 20 - 80 €)</li>
                <li><i class="fas fa-wrench text-success"></i> Changement de Pneus (Prix: 25 - 100 €)</li>
                <li><i class="fas fa-bolt text-info"></i> Entretien Complet (Prix: 50 - 200 €)</li>
                <li><i class="fas fa-paint-brush text-info"></i> Personnalisation de Vélos (Prix: 40 - 180 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Reparation des Velos"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="panne">Réparation de Pannes</option>
                        <option value="freins">Réglage de Freins</option>
                        <option value="pneus">Changement de Pneus</option>
                        <option value="entretien">Entretien Complet</option>
                        <option value="personnalisation">Personnalisation de Vélos</option>
