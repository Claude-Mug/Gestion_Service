...
<head>
    ...
    <title>Réparation de Montres et Accessoires - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Montres.jpg" alt="Réparation de Montres et Accessoires" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Montre.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Réparation de Montres</h3>
                    <i class="fas fa-clock fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-clock text-danger"></i> Réparation de Montres Mécaniques (Prix: 50 - 200 €)</li>
                <li><i class="fas fa-battery-full text-primary"></i> Remplacement de Batteries (Prix: 20 - 80 €)</li>
                <li><i class="fas fa-tools text-success"></i> Réparation de Bracelets (Prix: 30 - 100 €)</li>
                <li><i class="fas fa-cogs text-info"></i> Révision Complète (Prix: 100 - 300 €)</li>
                <li><i class="fas fa-glasses text-info"></i> Réparation d'Accessoires (Prix: 40 - 150 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Reparation des Montres"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="mecanique">Réparation de Montres Mécaniques</option>
                        <option value="batterie">Remplacement de Batteries</option>
                        <option value="bracelet">Réparation de Bracelets</option>
                        <option value="revision">Révision Complète</option>
                        <option value="accessoire">Réparation d'Accessoires</option>
