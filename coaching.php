...
<head>
    ...
    <title>Coaching Personnel - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Coaching.jpg" alt="Coaching Personnel" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Coachings.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Coaching Personnel</h3>
                    <i class="fas fa-user-graduate fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-comments text-danger"></i> Coaching de Vie (Prix: 50 - 150 € / séance)</li>
                <li><i class="fas fa-briefcase text-primary"></i> Coaching Professionnel (Prix: 60 - 200 € / séance)</li>
                <li><i class="fas fa-fitness text-success"></i> Coaching Sportif (Prix: 40 - 120 € / séance)</li>
                <li><i class="fas fa-heart text-info"></i> Coaching en Bien-être (Prix: 50 - 130 € / séance)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Coaching personnel"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group" id="date-request" style="display: none;">
                    <label for="request-date">Date de la Séance :</label>
