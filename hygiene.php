...
<head>
    ...
    <title>Soins d’hygiène et infirmiers - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Hygiene.jpg" alt="Soins d’hygiène et infirmiers" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Hygiene.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Soins d’hygiène et infirmiers</h3>
                    <i class="fas fa-user-nurse fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-first-aid text-danger"></i> Soins Infirmiers à Domicile (Prix: 30 - 100 €)</li>
                <li><i class="fas fa-bed text-primary"></i> Aide à la Mobilité (Prix: 20 - 60 € / heure)</li>
                <li><i class="fas fa-medkit text-success"></i> Soins de Convalescence (Prix: 25 - 80 € / heure)</li>
                <li><i class="fas fa-clipboard-list text-info"></i> Suivi Médical (Prix: 40 - 120 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="soins_hygiene_infirmiers"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="soins_infirmiers">Soins Infirmiers à Domicile</option>
                        <option value="aide_mobilite">Aide à la Mobilité</option>
                        <option value="soins_convalescence">Soins de Convalescence</option>
                        <option value="suivi_medical">Suivi Médical</option>
                ...
                <div class="form-group" id="date-request" style="display: none;">
                    <label for="request-date">Date de la Prestation :</label>
                ...
                <div class="form-group">
                    <label for="user-address">Adresse(Pays, ville, code postal) :</label>
