...
<head>
    ...
    <title>Peinture et Nettoyage - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Nettoyage.jpg" alt="Peinture et Nettoyage" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Nettoyage.png" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Peinture et Nettoyage</h3>
                    <i class="fas fa-paint-roller fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-paint-brush text-danger"></i> Peinture Intérieure (Prix: 20 - 50 € / m²)</li>
                <li><i class="fas fa-paint-roller text-primary"></i> Peinture Extérieure (Prix: 30 - 70 € / m²)</li>
                <li><i class="fas fa-broom text-success"></i> Nettoyage de Maison (Prix: 15 - 35 € / heure)</li>
                <li><i class="fas fa-spray-can text-info"></i> Nettoyage de Tapis (Prix: 25 - 60 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Peinture et Netoyage"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="peinture_interieure">Peinture Intérieure</option>
                        <option value="peinture_exterieure">Peinture Extérieure</option>
                        <option value="nettoyage_maison">Nettoyage de Maison</option>
                        <option value="nettoyage_tapis">Nettoyage de Tapis</option>
