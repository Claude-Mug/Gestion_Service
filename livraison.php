...
<head>
    ...
    <title>Livraisons - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Livraisons.jpg" alt="Livraisons" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Livraison.png" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Livraison</h3>
                    <i class="fas fa-truck fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-box text-danger"></i> Livraison de Colis (Prix: 5 - 50 €)</li>
                <li><i class="fas fa-shopping-cart text-primary"></i> Livraison de Courses (Prix: 10 - 30 €)</li>
                <li><i class="fas fa-furniture text-success"></i> Livraison de Meubles (Prix: 30 - 100 €)</li>
                <li><i class="fas fa-pizza-slice text-info"></i> Livraison de Repas (Prix: 5 - 20 €)</li>
                <li><i class="fas fa-gift text-info"></i> Livraison de Cadeaux (Prix: 5 - 40 €)</li>
                <li><i class="fas fa-tools text-primary"></i> Autre (précisez ci-dessous)</li>
            </ul>
            <p class="text-danger">*Les prix affichés sont pour les demandes normales. Les demandes urgentes auront un coût supérieur soit 20% sauf pour livraison de repas.</p>
        </div>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Livraison"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="livraison_courses">Livraison de Courses</option>
                        <option value="livraison_meubles">Livraison de Meubles</option>
                        <option value="livraison_repas">Livraison de Repas</option>
                        <option value="livraison_cadeaux">Livraison de Cadeaux</option>
                ...
                <div class="form-group">
                    <label for="user-address">Adresse de Livraison(Code postal et ville) :</label>
