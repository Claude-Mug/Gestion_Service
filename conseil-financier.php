...
<head>
    ...
    <title>Conseil Financier - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Finances.jpg" alt="Conseil Financier" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Finance.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Conseil Financier</h3>
                    <i class="fas fa-money-bill-alt fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-chart-line text-danger"></i> Analyse Financière (Prix: 100 - 500 €)</li>
                <li><i class="fas fa-calculator text-primary"></i> Planification Budgétaire (Prix: 80 - 300 €)</li>
                <li><i class="fas fa-user-shield text-success"></i> Gestion de Patrimoine (Prix: 150 - 600 €)</li>
                <li><i class="fas fa-chart-pie text-info"></i> Investissements (Prix: 200 - 700 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Conseil financier"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="planification_budgetaire">Planification Budgétaire</option>
                        <option value="gestion_patrimoine">Gestion de Patrimoine</option>
                ...
                <div class="form-group" id="date-request" style="display: none;">
                    <label for="request-date">Date de la Consultation :</label>
