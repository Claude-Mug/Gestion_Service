...
<head>
    ...
    <title>Service à Domicile pour Systèmes Électroménagers - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Electromenager.jpg" alt="Service à Domicile pour Systèmes Électroménagers" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Electromenager.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services electromenagers</h3>
                    <i class="fas fa-home fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-washing-machine text-danger"></i> Réparation de Lave-linges (Prix: 50 - 250 €)</li>
                <li><i class="fas fa-fridge text-primary"></i> Réparation de Réfrigérateurs (Prix: 70 - 300 €)</li>
                <li><i class="fas fa-oven text-success"></i> Réparation de Fours (Prix: 60 - 280 €)</li>
                <li><i class="fas fa-microwave text-info"></i> Réparation de Micro-ondes (Prix: 40 - 150 €)</li>
                <li><i class="fas fa-blender text-info"></i> Réparation de Robots de Cuisine (Prix: 30 - 120 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Electromenagers"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="lave-linge">Réparation de Lave-linges</option>
                        <option value="refrigerateur">Réparation de Réfrigérateurs</option>
                        <option value="four">Réparation de Fours</option>
                        <option value="micro-ondes">Réparation de Micro-ondes</option>
                        <option value="robot-cuisine">Réparation de Robots de Cuisine</option>
