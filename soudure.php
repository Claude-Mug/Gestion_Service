...
<head>
    ...
    <title>Services de Soudure - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Soudure.jpg" alt="Services de Soudure" class="img-fluid rounded" style="width: 65%; height: 350px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Soudures.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Soudure</h3>
                    <i class="fas fa-welding fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-archway text-danger"></i> Soudure Métallique (Prix: 100 - 500 €)</li>
                <li><i class="fas fa-cogs text-primary"></i> Réparation de Structures (Prix: 80 - 300 €)</li>
                <li><i class="fas fa-tools text-success"></i> Soudure de Tuyauterie (Prix: 70 - 250 €)</li>
                <li><i class="fas fa-wrench text-info"></i> Soudure de Pièces Détachées (Prix: 50 - 200 €)</li>
                <li><i class="fas fa-bolt text-info"></i> Soudure par Point (Prix: 60 - 220 €)</li>
                <li><i class="fas fa-clipboard-list text-primary"></i> Autre (précisez ci-dessous)</li>
            </ul>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Soudure"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="metallique">Soudure Métallique</option>
                        <option value="structures">Réparation de Structures</option>
                        <option value="tuyauterie">Soudure de Tuyauterie</option>
                        <option value="pieces">Soudure de Pièces Détachées</option>
                        <option value="point">Soudure par Point</option>
