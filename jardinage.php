...
<head>
    ...
    <title>Entretien Ménager et Jardinage - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Jardinages.jpg" alt="Entretien Ménager et Jardinage" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Jardinage.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services d'Entretien Ménager et Jardinage</h3>
                    <i class="fas fa-leaf fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-broom text-danger"></i> Nettoyage de Maison (Prix: 15 - 35 € / heure)</li>
                <li><i class="fas fa-shovel-alt text-primary"></i> Entretien de Jardin (Prix: 20 - 50 € / heure)</li>
                <li><i class="fas fa-seedling text-success"></i> Aménagement Paysager (Prix: 30 - 80 €)</li>
                <li><i class="fas fa-water text-info"></i> Arrosage et Entretien des Plantes (Prix: 15 - 40 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Entretien menager et jardinage"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="entretien_jardin">Entretien de Jardin</option>
                        <option value="amenagement_paysager">Aménagement Paysager</option>
                        <option value="arrosage_entretien">Arrosage et Entretien des Plantes</option>
