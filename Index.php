...
<style>
    ...
    <!-- Section des Avis -->
<div class="container visually-hidden mt-5" id="avis">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-3">
                 <li onclick="loadContent('passeoublier.php')">
                    <a href="#" onclick="event.preventDefault(); loadContent('passeoublier.php');">Mot de passe oublié ?</a>
                  </li>
                </div>
                <div class="mt-2">
