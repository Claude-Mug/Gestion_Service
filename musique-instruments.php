...
<head>
    ...
    <title>Réparation d'Instruments de Musique - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Musique.jpg" alt="Réparation d'Instruments de Musique" class="img-fluid rounded" style="width: 65%; height: 350px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Musiques.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Réparation d'Instruments</h3>
                    <i class="fas fa-music fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-guitar text-danger"></i> Réparation de Guitares (Prix: 50 - 200 €)</li>
                <li><i class="fas fa-trumpet text-primary"></i> Réparation de Cuivres (Prix: 70 - 300 €)</li>
                <li><i class="fas fa-violin text-success"></i> Réparation de Violons (Prix: 60 - 250 €)</li>
                <li><i class="fas fa-drum text-info"></i> Réparation de Batteries (Prix: 40 - 150 €)</li>
                <li><i class="fas fa-keyboard text-info"></i> Réparation de Claviers (Prix: 80 - 400 €)</li>
                <li><i class="fas fa-tools text-primary"></i> Autre (précisez ci-dessous)</li>
            </ul>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Reparation des intruments musique"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="guitare">Réparation de Guitares</option>
                        <option value="cuivres">Réparation de Cuivres</option>
                        <option value="violons">Réparation de Violons</option>
                        <option value="batteries">Réparation de Batteries</option>
                        <option value="claviers">Réparation de Claviers</option>
                ...
                <div class="form-group">
                    <label for="user-postal-code">Code Postal :</label>
                    <input type="text" class="form-control" id="user-postal-code" name="user_postal_code" required>
                </div>
                <div class="form-group">
                    <label for="user-city">Ville :</label>
                    <input type="text" class="form-control" id="user-city" name="user_city" required>
                </div>
                <div class="form-group">
