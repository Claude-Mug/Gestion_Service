...
<head>
    ...
    <title>Réparation de Caméras - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Cameras.jpg" alt="Réparation de Caméras" class="img-fluid rounded" style="width: 70%; height: 400px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Camera.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Réparation de Caméras</h3>
                    <i class="fas fa-camera-retro fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-camera text-danger"></i> Réparation de Caméras Numériques (Prix: 50 - 200 €)</li>
                <li><i class="fas fa-video text-primary"></i> Réparation de Caméras Vidéo (Prix: 100 - 400 €)</li>
                <li><i class="fas fa-lens text-success"></i> Remplacement d'Objectifs (Prix: 80 - 300 €)</li>
                <li><i class="fas fa-cogs text-info"></i> Réparation de Systèmes Internes (Prix: 60 - 250 €)</li>
                <li><i class="fas fa-battery-half text-info"></i> Remplacement de Batteries (Prix: 30 - 150 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Reparation des cameras"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="numerique">Réparation de Caméras Numériques</option>
                        <option value="video">Réparation de Caméras Vidéo</option>
                        <option value="objectif">Remplacement d'Objectifs</option>
                        <option value="systeme">Réparation de Systèmes Internes</option>
                ...
                <div class="form-group">
                    <label for="user-address">Adresse(ville, code postal):</label>
