...
<head>
    ...
    <title>Garde d'Enfants - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Enfant.jpg" alt="Garde d'Enfants" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Enfants.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Garde d'Enfants</h3>
                    <i class="fas fa-baby fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-clock text-danger"></i> Garde à Domicile (Prix: 15 - 25 € / heure)</li>
                <li><i class="fas fa-users text-primary"></i> Garde Partagée (Prix: 10 - 20 € / heure)</li>
                <li><i class="fas fa-school text-success"></i> Aide aux Devoirs (Prix: 12 - 22 € / heure)</li>
                <li><i class="fas fa-play-circle text-info"></i> Activités Éducatives (Prix: 15 - 30 € / heure)</li>
                <li><i class="fas fa-paint-brush text-info"></i> Garde d'Enfants Créative (Prix: 15 - 30 € / heure)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Garde des enfants"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="garde_partagee">Garde Partagée</option>
                        <option value="aide_devoirs">Aide aux Devoirs</option>
                        <option value="activites_educatives">Activités Éducatives</option>
                        <option value="garde_creative">Garde d'Enfants Créative</option>
