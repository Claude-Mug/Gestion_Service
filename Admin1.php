...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="list-group">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex flex-column">
                            <a href="Service.php" target="mainFrame" class="btn btn-primary mb-2">Ajouter un service</a>
                            <a href="Prix.php" target="mainFrame" class="btn btn-primary mb-2">Prix commande</a>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <h4>Prestataires</h4>
                        <div class="d-flex flex-column">
                            <a href="Prestateur.php" target="mainFrame" class="btn btn-success mb-2">Gérer les prestataires</a>
                            <a href="AjouterPrestataire.php" target="mainFrame" class="btn btn-primary mb-2">Ajouter un prestataire</a>
                        </div>
                    </div>
            ...
            <div class="col-md-12 main-content">
                ...
                <iframe name="mainFrame" id="mainFrame" style="width: 100%; height: calc(100vh - 150px); border: none;"></iframe>
            </div> 
        </div>
    </div>
    ...
    <script>
        function loadContent(content) {
            ...
            // Masquer les informations supplémentaires si ce n'est pas la page d'accueil
            if (content !== "tableau.php") {
        ...
        // Afficher les informations supplémentaires uniquement sur la page d'accueil au chargement initial
        document.addEventListener("DOMContentLoaded", function() {
            const additionalInfo = document.getElementById("additionalInfo");
            const mainFrame = document.getElementById("mainFrame");

            // Vérifier si l'iframe est sur la page d'accueil
            if (mainFrame.src.includes("Admin.php")) {
                additionalInfo.style.display = "none";
            } else {
                additionalInfo.style.display = "none";
            }
