...
<head>
    ...
    <title>Sécurité à Domicile - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Securite.jpg" alt="Sécurité à Domicile" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Securites.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Sécurité</h3>
                    <i class="fas fa-shield-alt fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-camera text-danger"></i> Installation de Caméras de Sécurité (Prix: 100 - 400 €)</li>
                <li><i class="fas fa-lock text-primary"></i> Installation de Serrures Sécurisées (Prix: 50 - 250 €)</li>
                <li><i class="fas fa-bell text-success"></i> Systèmes d'Alarme (Prix: 80 - 300 €)</li>
                <li><i class="fas fa-door-closed text-info"></i> Contrôle d'Accès (Prix: 100 - 500 €)</li>
                <li><i class="fas fa-fire text-info"></i> Détecteurs de Fumée et de Gaz (Prix: 30 - 150 €)</li>
                <li><i class="fas fa-user-shield text-warning"></i> Sécurité Maison de Gardes (Prix: 200 - 600 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    <input type="hidden" name="nom_service" value="service_a_domicile"> <!-- Champ caché pour le service à domicile -->
                    <input type="hidden" name="Domaine" value="Securite a domicile"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="cameras">Installation de Caméras de Sécurité</option>
                        <option value="serrures">Installation de Serrures Sécurisées</option>
                        <option value="alarmes">Systèmes d'Alarme</option>
                        <option value="controle_acces">Contrôle d'Accès</option>
                        <option value="detecteurs">Détecteurs de Fumée et de Gaz</option>
                        <option value="securite_gardes">Sécurité Maison de Gardes</option>
