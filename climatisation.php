...
<head>
    ...
    <title>Réparation de Climatisation et Micro-ondes - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Climatisation.jpg" alt="Réparation de Climatisation et Micro-ondes" class="img-fluid rounded" style="width: 70%; height: 400px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Climatisations.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Réparation</h3>
                    <i class="fas fa-wind fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-snowflake text-danger"></i> Réparation de Climatisations (Prix: 100 - 500 €)</li>
                <li><i class="fas fa-microchip text-primary"></i> Réparation de Micro-ondes (Prix: 50 - 300 €)</li>
                <li><i class="fas fa-cogs text-success"></i> Entretien de Systèmes (Prix: 60 - 250 €)</li>
                <li><i class="fas fa-plug text-info"></i> Installation de Climatisations (Prix: 200 - 800 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Reparation des climatisations"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="climatisation">Réparation de Climatisations</option>
                        <option value="micro-ondes">Réparation de Micro-ondes</option>
                        <option value="entretien">Entretien de Systèmes</option>
                        <option value="installation">Installation de Climatisations</option>
