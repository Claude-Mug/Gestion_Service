...
<head>
    ...
    <title>Déménagement - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Demenagement.jpg" alt="Déménagement" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Demenagements.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Déménagement</h3>
                    <i class="fas fa-truck-moving fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-box text-danger"></i> Déménagement Résidentiel (Prix: 200 - 800 €)</li>
                <li><i class="fas fa-building text-primary"></i> Déménagement Commercial (Prix: 300 - 1000 €)</li>
                <li><i class="fas fa-couch text-success"></i> Transport de Meubles (Prix: 150 - 600 €)</li>
                <li><i class="fas fa-hand-holding-box text-info"></i> Emballage et Déballage (Prix: 100 - 300 €)</li>
                <li><i class="fas fa-tools text-info"></i> Montage et Démontage (Prix: 50 - 200 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Demenagement"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="dem_en_residence">Déménagement Résidentiel</option>
                        <option value="dem_en_commercial">Déménagement Commercial</option>
                        <option value="transport_meubles">Transport de Meubles</option>
                        <option value="emballage">Emballage et Déballage</option>
                        <option value="montage_demontage">Montage et Démontage</option>
