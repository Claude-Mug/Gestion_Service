...
<head>
    ...
    <title>Services Électriques - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Electricite.jpg" alt="Services Électriques" class="img-fluid rounded" style="width: 60%; height: 300px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Electricite.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services Électriques</h3>
                    <i class="fas fa-bolt fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-lightbulb text-danger"></i> Installation Électrique (Prix: 100 - 500 €)</li>
                <li><i class="fas fa-wrench text-primary"></i> Réparation de Pannes (Prix: 50 - 200 €)</li>
                <li><i class="fas fa-plug text-success"></i> Entretien de Systèmes (Prix: 30 - 150 €)</li>
                <li><i class="fas fa-battery-full text-info"></i> Diagnostic Électrique (Prix: 60 - 120 €)</li>
                <li><i class="fas fa-screwdriver text-info"></i> Installation de Prises (Prix: 80 - 300 €)</li>
                <li><i class="fas fa-cogs text-info"></i> Mise aux Normes (Prix: 200 - 1000 €)</li>
                <li><i class="fas fa-chart-line text-primary"></i> Réparation de Systèmes de Sécurité (Prix: 70 - 250 €)</li>
                <li><i class="fas fa-tools text-danger"></i> Autre (précisez ci-dessous)</li>
            </ul>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Reparations Electriques"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="reparation">Réparation de Pannes</option>
                        <option value="entretien">Entretien de Systèmes</option>
                        <option value="diagnostic">Diagnostic Électrique</option>
                        <option value="prises">Installation de Prises</option>
                        <option value="normes">Mise aux Normes</option>
                        <option value="securite">Réparation de Systèmes de Sécurité</option>
