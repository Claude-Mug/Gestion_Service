...
<head>
    ...
    <title>Services de Plomberie - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Plomberie.jpg" alt="Services de Plomberie" class="img-fluid rounded" style="width: 65%; height: 350px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Plomberies.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services de Plomberie</h3>
                    <i class="fas fa-water fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-tap text-danger"></i> Réparation de Fuites (Prix: 50 - 200 €)</li>
                <li><i class="fas fa-shower text-primary"></i> Installation de Douches (Prix: 100 - 400 €)</li>
                <li><i class="fas fa-toilet text-success"></i> Réparation de Toilettes (Prix: 80 - 300 €)</li>
                <li><i class="fas fa-sink text-info"></i> Installation de Lavabos (Prix: 60 - 250 €)</li>
                <li><i class="fas fa-wrench text-info"></i> Entretien de Systèmes (Prix: 70 - 350 €)</li>
                <li><i class="fas fa-pipe text-info"></i> Débouchage de Canalisations (Prix: 80 - 300 €)</li>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Plomberie"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="fuite">Réparation de Fuites</option>
                        <option value="douche">Installation de Douches</option>
                        <option value="toilette">Réparation de Toilettes</option>
                        <option value="lavabo">Installation de Lavabos</option>
                        <option value="entretien">Entretien de Systèmes</option>
                        <option value="debouchage">Débouchage de Canalisations</option>
