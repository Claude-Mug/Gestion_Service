...
<head>
    ...
    <title>Services Mécaniques - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Mecanique.jpg" alt="Services Mécaniques" class="img-fluid rounded" style="width: 70%; height: 400px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Mecanique.png" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services Mécaniques</h3>
                    <i class="fas fa-car fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-wrench text-danger"></i> Réparation de Véhicules (Prix: 100 - 500 €)</li>
                <li><i class="fas fa-oil-can text-primary"></i> Entretien Préventif (Prix: 50 - 200 €)</li>
                <li><i class="fas fa-tired text-success"></i> Services de Pneus (Prix: 30 - 150 €)</li>
                <li><i class="fas fa-plug text-info"></i> Diagnostic Électronique (Prix: 60 - 120 €)</li>
                <li><i class="fas fa-car-crash text-info"></i> Réparation de Systèmes de Freinage (Prix: 80 - 300 €)</li>
                <li><i class="fas fa-car-side text-info"></i> Restaurations et Modifications (Prix: 200 - 1000 €)</li>
                <li><i class="fas fa-tools text-primary"></i> Réparation de Climatisation (Prix: 70 - 250 €)</li>
                <li><i class="fas fa-battery-half text-danger"></i> Remplacement de Batteries (Prix: 50 - 150 €)</li>
                <li><i class="fas fa-cogs text-info"></i> Réparation de Boîtes de Vitesses (Prix: 150 - 600 €)</li>
                <li><i class="fas fa-shield-alt text-danger"></i> Vérification de Sécurité (Prix: 40 - 100 €)</li>
                <li><i class="fas fa-car text-warning"></i> Nettoyage et Détail (Prix: 30 - 120 €)</li>
                <li><i class="fas fa-tools text-success"></i> Autre (précisez ci-dessous)</li>
            </ul>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Reparation Mecaniques"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="reparation">Réparation de Véhicules</option>
                        <option value="entretien">Entretien Préventif</option>
                        <option value="pneus">Services de Pneus</option>
                        <option value="diagnostic">Diagnostic Électronique</option>
                        <option value="freins">Réparation de Systèmes de Freinage</option>
                        <option value="restauration">Restaurations et Modifications</option>
                        <option value="climatisation">Réparation de Climatisation</option>
                        <option value="batterie">Remplacement de Batteries</option>
                        <option value="vitesses">Réparation de Boîtes de Vitesses</option>
                        <option value="securite">Vérification de Sécurité</option>
                        <option value="nettoyage">Nettoyage et Détail</option>
