...
<head>
    ...
    <title>Réparation d'Appareils Électroniques - Homme Services</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12 text-center">
            <img src="Images/Electronique.jpg" alt="Réparation d'Appareils Électroniques" class="img-fluid rounded" style="width: 65%; height: 350px;">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <img src="Images/Electroniques.jpg" alt="Icône Services" class="img-thumbnail mr-3" style="width: 100px; height: 100px;">
                <div>
                    <h3 class="header-text">Nos Services Electroniques</h3>
                    <i class="fas fa-tools fa-5x text-primary"></i>
                </div>
            </div>
            <ul class="list-unstyled mt-3" style="background-color: rgb(228, 232, 232);">
                <li><i class="fas fa-mobile-alt text-danger"></i> Réparation de Smartphones (Prix: 50 - 200 €)</li>
                <li><i class="fas fa-laptop text-primary"></i> Réparation d'Ordinateurs (Prix: 100 - 400 €)</li>
                <li><i class="fas fa-tv text-success"></i> Réparation de Téléviseurs (Prix: 80 - 300 €)</li>
                <li><i class="fas fa-headphones-alt text-info"></i> Réparation de Casques Audio (Prix: 30 - 100 €)</li>
                <li><i class="fas fa-tablet-alt text-info"></i> Réparation de Tablettes (Prix: 60 - 250 €)</li>
                <li><i class="fas fa-camera text-info"></i> Réparation d'Appareils Photo (Prix: 70 - 350 €)</li>
                <li><i class="fas fa-cogs text-primary"></i> Autre (précisez ci-dessous)</li>
            </ul>
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="Service.php">
                ...
                <div class="form-group" style="display: none;"> 
                    ...
                    <input type="hidden" name="Domaine" value="Reparation Electoniques"> <!-- Champ caché pour soins d’hygiène et infirmiers -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service-select" name="service" required>
                        ...
                        <option value="smartphone">Réparation de Smartphones</option>
                        <option value="ordinateur">Réparation d'Ordinateurs</option>
                        <option value="television">Réparation de Téléviseurs</option>
                        <option value="casque">Réparation de Casques Audio</option>
                        <option value="tablette">Réparation de Tablettes</option>
                        <option value="appareil_photo">Réparation d'Appareils Photo</option>
